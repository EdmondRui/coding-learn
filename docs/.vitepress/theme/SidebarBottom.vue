...
<template>
  <div class="sidebar-bottom">
    <div class="sidebar-bottom-row">
      <span class="sidebar-bottom-label">主题</span>
      <button
    ...
    <div class="sidebar-bottom-row">
      <a
        ...
        href="https://github.com/EdmondRui/coding-learn"
        target="_blank"
        rel="noreferrer"
        title="GitHub"
      >
...
/* Theme icon visibility is CSS-driven (not v-if) so that SSR output
   matches client in both light/dark — avoids hydration mismatches. */
.theme-icon {
  display: none;
}
